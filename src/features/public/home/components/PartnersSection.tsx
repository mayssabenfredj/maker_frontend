        ...
        {partners.map((partner, index) => (
          <AnimatedSection key={partner._id} delay={index * 0.1}>
            <motion.div
              ...
              } group flex flex-col h-full`} // Added flex, flex-col, h-full
            >
              <img
              ...
              <span className="inline-block bg-orange-500 text-white px-3 py-1 rounded-full text-xs font-medium mb-3 flex-grow">
                {partner.specialite}
              </span>
              <a
                ...
                className="mx-auto inline-flex items-center mt-auto text-blue-900 hover:text-orange-500 transition-colors" // Changed mt-3 to mt-auto
              >
