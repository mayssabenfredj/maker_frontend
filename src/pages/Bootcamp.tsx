...
import { Calendar, Clock, Users, Award, CheckCircle, ArrowRight, Target, Zap, Trophy } from 'lucide-react';
  ...
  const bootcamps = [
    {
      ...
      description: 'Formation intensive de 16 semaines pour devenir expert en intelligence artificielle',
    ...
    },
    {
      ...
      description: 'Apprenez à concevoir et développer des solutions IoT complètes',
    ...
    },
    {
      ...
      description: 'Formation complète en robotique et automatisation industrielle',
  ...
  const benefits = [
    {
      ...
      description: 'Apprentissage accéléré avec 40h/semaine de formation pratique'
    },
    {
      icon: Users,
          ...
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className={`text-xl max-w-3xl mx-auto ${
                ...
                Transformez votre carrière en quelques mois avec nos formations intensives
              </p>
            </div>
          </AnimatedSection>
        </div>
                    ...
                    <div className="lg:col-span-2">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex flex-wrap gap-2">
                          {bootcamp.technologies.slice(0, 3).map((tech, idx) => (
                            <span
                              key={idx}
