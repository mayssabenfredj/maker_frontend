...
import { 
  ...
  MessageSquare, ShoppingBag, Zap, ArrowUpRight,
            ...
            {recentActivities.map((activity, index) => (
              ...
              >
                {activity.avatar ? (
                  ...
                  <div className={`w-10 h-10 rounded-full ${index % 2 === 0 ? 'bg-orange-500' : 'bg-blue-600'} flex items-center justify-center`}>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full ${
                    event.type === 'bootcamp' ? 'bg-orange-500 text-white' :
                    event.type === 'workshop' ? 'bg-blue-600 text-white' :
                    event.type === 'meeting' ? 'bg-orange-600 text-white' :
