...
const FormationsManagement: React.FC = () => {
  ...
  const formations = [
    ...
    },
    {
      ...
      description:
        "Implémentez des algorithmes ML pour résoudre des problèmes réels",
      image:
  ...
  const filteredFormations = formations.filter((formation) => {
    ...
    const matchesCategory =
      filterCategory === "all" || formation.category === filterCategory;
            ...
            >
              <div className="relative">
                ...
                <div className="absolute top-4 left-4 flex space-x-2">
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-white text-xs font-medium ${getLevelColor(
                      formation.level
                    )}`}
                  >
