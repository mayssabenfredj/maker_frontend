...
import { Plus, Search, Calendar, Users, MapPin, Clock, Edit, Trash2, Eye } from 'lucide-react';
...
const EventsManagement: React.FC = () => {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'hackathon': return 'bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-400';
      case 'exhibition': return 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400';
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
                      {Math.round((event.registeredAttendees / event.maxAttendees) * 100)}%
                    </span>
                  </div>
