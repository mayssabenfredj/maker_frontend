...
const Formations: React.FC = () => {
  ...
  const mockCourses = [
    ...
    },
    {
      ...
      description: { fr: 'Introduction ludique à l\'intelligence artificielle', en: 'Fun introduction to artificial intelligence' },
    ...
    },
    {
      ...
      description: { fr: 'Maîtrisez Python pour l\'IA et l\'IoT', en: 'Master Python for AI and IoT' },
    ...
    },
    {
      ...
      description: { fr: 'Construis ton premier robot', en: 'Build your first robot' },
    ...
    },
    {
      ...
      description: { fr: 'Formation intensive en intelligence artificielle', en: 'Intensive artificial intelligence training' },
          ...
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className={`text-xl max-w-3xl mx-auto ${
                ...
                Développez vos compétences avec nos formations en technologies innovantes
              </p>
            </div>
          </AnimatedSection>
        </div>
              ...
              <AnimatedSection key={course.id} delay={index * 0.1}>
                ...
                >
                  <div className="relative">
                    ...
                    <div className={`absolute top-4 right-4 px-2 py-1 rounded-full text-xs font-medium ${getLevelColor(course.level)}`}>
